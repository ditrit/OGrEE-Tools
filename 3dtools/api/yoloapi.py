...
ROOT = FILE.parents[1] / "yolov5"  # YOLOv5 root directory
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=FILE.parents[1]/'image/YOLO_serveur/test/images', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'yolov5/data/serveur122.yaml', help='(optional) dataset.yaml path')
    ...
    parser.add_argument('--agnostic-nms', action='store_true', help='if provided, class-agnostic NMS')
    ...
    parser.add_argument('--update', action='store_true', help='if provided, update all models')
    ...
    parser.add_argument('--half', action='store_true', help='if provided, use FP16 half-precision inference')
    parser.add_argument('--dnn', action='store_true', help='if provided, use OpenCV DNN for ONNX inference')
